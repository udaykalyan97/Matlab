...
mkdir('Negative_AvgPower_Female');                                        %Creates output in newFolder in Present working Directory
cd('Negative_AvgPower_Female');


%%%%Intialization%%%%%%%%%%%%%%%%
%posi
%good_epochs = [41,50,50,50,49,50,50,49,50,49,50,49,45,49,50,50,50,50,50,50,48,50,49,50,50,49];

%neut
%good_epochs = [47,50,50,50,49,50,50,48,50,50,50,49,41,50,50,50,49,50,49,50,48,50,49,50,50,49];

%nega
good_epochs = [41,50,50,50,50,50,50,49,50,50,50,49,43,48,49,50,50,50,50,50,49,50,50,50,50,49];

subjects = {'S1 TFP nega.set','S2 TFP nega.set','S5 TFP nega.set','S6 TFP nega.set','S7 TFP nega.set','S8 TFP nega.set','S10 TFP nega.set','S15 TFP nega.set','S16 TFP nega.set','S23 TFP nega.set','S32 TFP nega.set','S37 TFP nega.set','S42 TFP nega.set','S44 TFP nega.set','S49 TFP nega.set','S53 TFP nega.set','S55 TFP nega.set','S56 TFP nega.set','S57 TFP nega.set','S61 TFP nega.set','S63 TFP nega.set','S70 TFP nega.set','S74 TFP nega.set','S82 TFP nega.set'};
